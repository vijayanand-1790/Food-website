...
const Navbar = () => {
    ...
    return (
        <>
            <div className="flex justify-between items-center mx-auto lg:px-10 px-5 pt-6">
            ...
            {/* side drawer menu */}
            <div className={ menuOpen ? "bg-white fixed h-screen md:w-[300px] w-[260px] top-0 left-0 z-10 duration-300 pl-5 pt-5" : "bg-white fixed h-screen w-[300px] top-0 -left-[100%] z-10 duration-300 "}>
